...
class LabelTests(LabelTestBase):
    ...
    # For the momentthe adios_db Session does not support editing / changing labels
    # So the API can't perform any modifications.
    # tests commented out in case we want this functionality in the future
    # @pytest.mark.skip
