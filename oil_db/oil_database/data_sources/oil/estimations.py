## FIXME:
## there is a LOT in here (most of it?) that we don't need.
## we really need to clean this out an refactor it.
...
class OilEstimation(object):
    '''
    TRIMMED to heck! for the new code.
    ...
    def py_class_from_name(self, fully_qualified_name):
        ...
        if scope == '':
            ...
            for scope in ('oil_database.models.common.float_unit',):
                try:
...
class OilSampleEstimation(object):
    ...
    def get_api(self):
        '''
            ...
            FIXME: there should only be one API per record!
        '''
        try:
